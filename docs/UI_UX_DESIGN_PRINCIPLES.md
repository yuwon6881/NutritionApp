...
| Navigation and committed page transitions | `App.tsx`, `MotionScene`, `MotionPanel`, `SelectionIndicator` | Keep routing in the app shell and let the existing motion wrappers handle destination focus and bounded entrance movement. |
