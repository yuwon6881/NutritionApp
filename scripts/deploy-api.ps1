...
$nutritionEnvironment = "PublicOrigin=$PublicOrigin,Auth__MaxUsers=2,Database__MigrateOnStartup=false,Retention__MealDetailDays=7,Physique__Bucket=financialapp-vault-396431756440,ScanStorage__Bucket=nourish-scans-396431756440,OpenAi__Model=gpt-5.4-mini"
