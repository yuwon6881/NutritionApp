...
export function WeightChart({weights,smoothed}:{weights:Point[];smoothed:Point[]}){
  ...
  return <section className="panel"><div className="section-heading"><div><h2>The direction over time</h2><p>Scale weight and a calculated trend with a seven-day smoothing half-life.</p></div>
