...
export type Day=RecordBase&{date:string;status:'incomplete'|'complete'|'fasting';archived?:boolean;entryCount?:number;calories?:number;protein?:number|null;fat?:number|null;carbs?:number|null;fiber?:number|null};
...
export type GoalProgress={mode:string;percent:number|null;complete:boolean;estimatedFinish:string|null;phaseEnd:string|null;trendWeight:number|null;weeklyChange:number|null;explanation:string};
