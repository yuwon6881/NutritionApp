...
const port = parseInt(process.env.PORT || process.argv[2] || '5085', 10);
  ...
  if (reqUrl.pathname === '/connect/authorize') {
    if (req.method === 'GET') {
      ...
      if (reqUrl.searchParams.get('auto') === 'true') {
        ...
        const username = (reqUrl.searchParams.get('username') || 'test-alice').trim();
...
<body style="font-family:system-ui;padding:2rem;">
  ...
  <form method="POST" action="/connect/authorize">
    ...
    <input id="username" name="username" value="test-alice" style="padding:8px;font-size:16px;margin:8px 0;" /><br />
