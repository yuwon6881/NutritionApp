...
param(
    ...
    [string]$JobName = 'nutrition-check-in-push',
    [string]$ApiOrigin = '',
...
$uri = "$($ApiOrigin.TrimEnd('/'))/internal/nutrition-check-in-dispatch"
...
Write-Output "Configured $JobName in $Region to POST every five minutes."
